...
META = {
    ...
    "pp-terms-of-service.md": ("Terms of Service (SaaS)", DRAFT),
    "pp-privacy-policy.md": ("Privacy Policy", DRAFT),
    "pp-dpa.md": ("Data Processing Agreement (Art 28)", DRAFT),
    "pp-security-data-protection-policy.md": ("Security & Data Protection Policy", DRAFT),
    "pp-clinical-governance-policy.md": ("Clinical Governance Policy", DRAFT),
    "pp-crisis-safeguarding-policy.md": ("Crisis & Safeguarding Policy", DRAFT),

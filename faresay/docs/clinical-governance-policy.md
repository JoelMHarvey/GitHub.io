...
- where applicable in a US state, any professional entity ("friendly PC" / professional corporation) through which clinical services are contracted or supervised.
...
- **"Clinical Services"** means the regulated mental-health, psychotherapy, or counselling services a Practitioner provides to Clients.
- **"Compact"** means an interstate licensure compact relevant to mental-health practice, including PSYPACT (psychology), the Counseling Compact, and the Social Work Licensure Compact.
- **"DBS"** means the UK Disclosure and Barring Service.
- **"Friendly PC" / "PC"** means a US professional corporation or professional entity through which clinical services may be contracted or supervised in a corporate-practice state.
- **"MSO"** means a management services organisation (Faresay's commercial / non-clinical entity in a US corporate-practice structure).
- **"Practitioner"** means an independent, licensed mental-health professional onboarded to deliver Clinical Services through the Platform.
- **"Professional Body"** means the relevant statutory regulator or professional membership/accreditation body for a Practitioner (see Section 18).
...
- **"Scope of Practice"** means the range of clinical activities a Practitioner is qualified, trained, competent, and licensed/registered to perform.
- **"State"**, in the US context, means a US state or the District of Columbia.
...
- **PSYPACT** for qualifying psychologists;
- the **Counseling Compact** for qualifying professional counsellors;
- the **Social Work Licensure Compact** for qualifying clinical social workers.
...
- monitoring **licence/registration expiry** and requiring evidence of renewal before lapse;
- periodic re-verification of standing with each relevant Professional Body / State board on a defined cadence ([PLACEHOLDER: e.g. at least annually, and on renewal]);
- monitoring for **disciplinary actions, sanctions, conditions, suspensions, or restrictions**, including (US) checks against State board actions and relevant national databases. ⚠️ COUNSEL: confirm permissible/required sources (e.g. NPDB access eligibility, OIG/SAM exclusion lists, State board disciplinary feeds) — access to some databases is restricted to certain entity types.
...
- circumstances where the Client cannot be safely treated remotely (e.g. no safe, private environment; jurisdictional/age limits).
...
- **secure and confidential** — stored to the security standard required by law and `security-data-protection-policy.md`;
- **retained** for the period required by the Practitioner's jurisdiction(s) and Professional Body, and then securely disposed of.
...
- individuals in acute crisis or at imminent risk of harm to self or others (route to emergency services / crisis pathways per `crisis-safeguarding-policy.md`);
- presentations requiring emergency, in-person, or higher-intensity care than telehealth can safely provide (see 6.2);
- individuals located outside a jurisdiction where a suitably-licensed Practitioner is available;
- **minors** — [PLACEHOLDER: whether under-18s are served; if so, age thresholds, parental/guardian consent, and additional safeguards]. ⚠️ CLINICAL / ⚠️ COUNSEL: serving minors materially increases clinical and legal complexity (consent, safeguarding, mandatory reporting); confirm explicitly whether the Platform serves minors at launch.
...
- **BACP** (British Association for Counselling and Psychotherapy) — ethical framework and accreditation for counsellors/psychotherapists.
- **UKCP** (UK Council for Psychotherapy) — register and standards for psychotherapists.
- **BPS** (British Psychological Society) — professional body / practice guidance for psychologists.
- [PLACEHOLDER: other relevant bodies — e.g. BABCP, NCPS — and which Faresay recognises.]

16.3 **United States (indicative).**

- **State licensing boards** — the primary source of licensure authority and disciplinary rules in each State (psychology, professional counselling, clinical social work, marriage & family therapy).
- **APA** (American Psychological Association) — Ethical Principles of Psychologists and Code of Conduct (psychologists).
- **ACA** (American Counseling Association) — Code of Ethics (counsellors).
- **NASW** (National Association of Social Workers) — Code of Ethics (clinical social workers).
- [PLACEHOLDER: other relevant codes/bodies — e.g. AAMFT for marriage & family therapists.]
- Interstate compacts — **PSYPACT**, the **Counseling Compact**, the **Social Work Licensure Compact** (see Section 4).
...
- `therapist-agreement.md` — Practitioner contractual terms (credentialing, records, fee characterisation).
- `crisis-safeguarding-policy.md` — crisis, risk, safeguarding, and escalation pathways (cross-referenced throughout).
- `privacy-policy.md` and `security-data-protection-policy.md` — data protection and security.

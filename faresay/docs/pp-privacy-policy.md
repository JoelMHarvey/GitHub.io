...
> This policy should be read alongside our [Security & Data Protection Policy](pp-security-data-protection-policy.md) and, for therapists, the [Data Processing Agreement](pp-dpa.md) and the SaaS subscription terms. Preparatory material — see also the [UK Legal Brief](pp-uk-legal-brief.md).
...
- **Data Protection Officer (if/when appointed):** [PLACEHOLDER: DPO name and contact] — see Section 12 and the [Security & Data Protection Policy](pp-security-data-protection-policy.md)
...
Faresay is the **controller** of the data it processes for its own business purposes — that is, the data **about the therapist** (our customer) and about **visitors to our website**. This includes:
- therapist **account and identity** data;
- **billing and subscription** data;
- **usage and analytics** data about how the portal and website are used;
...
- **Faresay is a processor**, governed by a **Data Processing Agreement (DPA)** under UK GDPR Article 28 (see [pp-dpa.md](pp-dpa.md)); and
...
> **Not covered here:** a therapist's **clients'** personal data (intake, session, clinical-note and mental-health information). Faresay processes that only as a **processor** on the therapist's instructions under the [DPA](pp-dpa.md) — see Section 1.2.
...
We share **controller** personal data only as described below. Each of these providers acts as a **processor or sub-processor** for Faresay's controller data under a written contract (Article 28 terms), and is also listed in our [Security & Data Protection Policy](pp-security-data-protection-policy.md).
...
> For a therapist's **clients' data**, sharing is governed by the [DPA](pp-dpa.md) — Faresay shares it only on the therapist's documented instructions and with the sub-processors listed there.
...
⚠️ **COUNSEL** — finalise the transfer mechanism for each data flow (Clerk, Daily, Resend, Neon and the payment provider), confirm current adequacy / DPF status, select UK/EU hosting regions where available, and ensure the same mechanisms flow down through the [DPA](pp-dpa.md) for client data.
...
> Retention of a therapist's **clients' data** is governed by the [DPA](pp-dpa.md) and the therapist's own clinical-records obligations — Faresay returns or deletes that data on the therapist's instruction or on termination, as the controller directs.
...
Where Faresay is the **controller** of your data, and subject to applicable law, you have the right to:
- **access** the personal data we hold about you (a subject access request / DSAR);
- request **rectification** of inaccurate data;
- request **erasure** in certain circumstances;
- **restrict** or **object** to certain processing;
- **data portability**;
- **withdraw consent** at any time where processing is based on consent; and
- not be subject to solely automated decisions with legal/similarly significant effects.
...
> **If you are a client of a therapist:** to exercise rights over **your** data, contact **your therapist** (the controller), not Faresay. Faresay will assist the therapist in responding, as required by the [DPA](pp-dpa.md).
...
Our incident-response approach is detailed in the [Security & Data Protection Policy](pp-security-data-protection-policy.md).
...
**Privacy / data-protection contact:** privacy@faresay.com — [PLACEHOLDER: postal address]

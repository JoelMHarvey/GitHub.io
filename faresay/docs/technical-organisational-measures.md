> ⚠️ DRAFT v0.1 — template for professional sign-off. NOT legal advice. Some controls describe target state; each is flagged. Last updated: 25 June 2026

# Faresay Technical & Organisational Measures (TOMs)

This document is **Annex 2** to the [Data Processing Agreement](data-processing-agreement.md). It describes the technical and organisational security measures Faresay maintains under **Article 32 of the UK GDPR**, appropriate to the risk of processing **special-category (mental-health) data**.
...
- Retention and deletion follow the DPA (export window + deletion timeline) and the [Privacy Policy](privacy-policy.md).

## 8. Sub-processor security

- Sub-processors are selected for their security posture and bound by contractual data-protection obligations no less protective than the DPA. See [Sub-processor List](sub-processor-list.md).
